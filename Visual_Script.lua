...
local Window = Rayfield:CreateWindow({
    Name = "Zephyr Mail Stealer Soon",
    LoadingTitle = "Zephyr Visual",
    LoadingSubtitle = "by Mr.Exploit",
    ConfigurationSaving = {
        Enabled = false,
        FolderName = "ZephyrF", -- Create a custom folder for your hub/game
        FileName = "Zephyr Hub"
    },
    Discord = {
        Enabled = false,
